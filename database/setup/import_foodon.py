...
from lib.gen_synonyms import gen_synonyms
...
ONTO_PATH = ONTO_PATH = os.getenv("ONTO_PATH", os.path.join(CUR_DIR, "..", "import", "foodon-full.owl"))
...
def import_descendants(classes, root_label):
    ...
    for cls in classes:
        ...
        owl_synonyms = get_exact_synonyms(cls)
        auto_synonyms = gen_synonyms(final_label)
        combined_synonyms = list(set(owl_synonyms + auto_synonyms))
